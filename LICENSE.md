...
Anodex is **source available, not open source.**
...
- **Use the official released builds** of Anodex.
...
it.** Every third-party library, runtime, model, font and bundled component remains under
its own licence, held by its own authors, and those licences govern it entirely.

Nothing in this file claims ownership of anything Anodex did not write.

See [`docs/THIRD_PARTY_AUDIT.md`](docs/THIRD_PARTY_AUDIT.md) for what ships and under what
terms. Where a third-party licence requires a notice, that notice travels with the
component in the installed application.
...
This matters more than usual here, because Anodex runs commands, edits files and reaches
the network on your behalf. Review what it proposes before you approve it.
